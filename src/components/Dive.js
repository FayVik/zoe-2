      ...
      <div class="container p-1 p-lg-5">
        <Switch>
          ...
          <Route path="/credits">
            ...
            <p>
              This site was made with love by the ZOEPOOL team, with design help
              from Gimbalabs.
            </p>
            <p>All photos are by Darlington Sheriff. For more info see:</p>
            <ul>
              <li>
                <a href="https://Instagram.com/darlingtonsheriff">
                  Instagram @darlingtonsheriff
                </a>
              </li>
              <li>
                <a href="https://Youtube.com/darlingtonsheriff">YouTube</a>
              </li>
              <li>
                <a href="https://Twitter.com/darlingsheriff">
                  Twitter @darlingsheriff
                </a>
              </li>
            </ul>
          </Route>
